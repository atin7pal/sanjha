        ...
        <section className="bg-[#e6e8dd] mx-10 my-10 h-[110vh] w-auto rounded-[40px] max-sm:mx-5 max-sm:my-3 max-sm:h-[100vh] max-[850px]:h-[100%]">
          ...
          >
            <div className="w-full h-full flex flex-col justify-center px-10 gap-5 max-sm:items-center max-sm:bg-white/60 max-sm:py-9 max-sm:text-center max-sm:backdrop-blur-sm max-[850px]:py-7">
              ...
              <div className="flex gap-5 w-[60%] max-sm:w-full max-[850px]:w-full max-[850px]:gap-3">
                <button className="rounded-full w-full px-8 py-3 bg-[#009688] text-white border-2 border-[#009688] text-sm hover:text-[#009688] hover:bg-transparent hover:border-2 hover:border-[#548776] transition-all max-[850px]:py-1.5 max-[850px]:w-full max-sm:px-4  max-[850px]:px-5">
                  Reserve a table
                </button>
